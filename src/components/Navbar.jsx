    ...
    <nav className=" bg-transparent py-4  absolute top-0 w-full z-40">
      <div className=" max-w-full sm:max-w-3xl mx-auto px-4 flex justify-between sm:justify-center items-center">
        ...
        <div className="md:flex items-center">
            <a href="https://dexscreener.com/solana/grfa2xc4ro6gmz2oeg44tmb3ipgjfqtw4x5r5aq1gzx4" className="bg-[#000000] rounded-full text-white px-4 py-2 text-xl font-kid  font-semibold ">Buy Now</a>
        </div>
      ...
      >
        {(ref) => (
          ...
          >
            ...
            <a
                  href="hhttp://twitter.com/sleepy_catt1"
                ...
                <a
                  href="https://t.me/sleepycatso" target="_blank"
                  className=" text-xl text-black bg-white hover:bg-[#1a4093] rounded-full p-2 border-2 border-[#000]  hover:text-[#fff]"
                >
                  <FaTelegram />
                </a>
